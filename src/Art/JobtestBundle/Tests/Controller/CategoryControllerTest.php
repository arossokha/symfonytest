...
class CategoryControllerTest extends WebTestCase
{
    public function testShow()
    {
        ...
        $categories = $this->em->getRepository('ArtJobtestBundle:Category')->getWithJobs();
        ...
        foreach ($categories as $category) {
            ...
            $this->assertEquals('Art\JobtestBundle\Controller\CategoryController::showAction', $client->getRequest()->attributes->get('_controller'));
            $this->assertEquals($category->getSlug(), $client->getRequest()->attributes->get('slug'));

            $jobs_no = $this->em->getRepository('ArtJobtestBundle:Job')->countActiveJobs($category->getId());
